    ...
    <div className="card">
      ...
      <div style={{ lineHeight: '1.8', color: '#555' }}>
        <p style={{ marginBottom: '15px' }}>
          <strong>Problem Statement:</strong> Accurate energy load forecasting is critical for 
        ...
        <p style={{ marginBottom: '15px' }}>
          <strong>Methodology:</strong> This system employs an ensemble approach combining 
        ...
        <p style={{ marginBottom: '15px' }}>
          <strong>Data Sources:</strong> The system integrates comprehensive weather metrics from 
        ...
        <p>
          <strong>Key Features:</strong> The ensemble automatically selects optimal models based 
