...
def train_xgboost(evaluate_cv: bool = True, save_model: bool = True, use_hyperopt: bool = True):
    """
    Train XGBoost model with cross-validation evaluation.
...
if __name__ == '__main__':
    train_xgboost(evaluate_cv=True, save_model=True, use_hyperopt=True)
